 ...
 */ class $9aede8581b16c941$var$DexieWrapper {
     ...
     */ async getAllMeasurements(imageIdentifier) {
        ...
        for(let i = 0; i < result.length; i++){
            let measurement = new $9aede8581b16c941$var$Measurement(new $9aede8581b16c941$var$Point(result[i].p1x, result[i].p1y, result[i].color, this.plugin.fabricCanvas, this.imageIdentifier), new $9aede8581b16c941$var$Point(result[i].p2x, result[i].p2y, result[i].color, this.plugin.fabricCanvas, this.imageIdentifier), result[i].name, result[i].color, this.plugin.conversionFactor, this.plugin.units, this.plugin.fabricCanvas, this.imageIdentifier, this.plugin);
 ...
 */ class $9aede8581b16c941$var$OSDMeasure {
    /**
     ...
     */ constructor(viewer, options = {}){
        ...
        this.viewer.addHandler("canvas-click", (event)=>{
            ...
            for(let i = 0; i < this.measurements.length; i++)if (this.measurements[i].isPointInside(imagePoint.x, imagePoint.y)) {
                // Check if the clicked measurement is the same as the selectedMeasurement
                if (this.selectedMeasurement === this.measurements[i]) // If it is, deselect it
                this.deselectMeasurement();
                else // If it's not, select it
    ...
    selectMeasurement(measurement) {
        ...
        if (this.selectedMeasurement) this.deselectMeasurement();
 ...
 */ class $9aede8581b16c941$var$Measurement {
    ...
    select() {
        ...
        this.p1.fabricObject.set({
            fill: "grey"
        });
        this.p2.fabricObject.set({
            fill: "grey"
        });
        this.textObject.set({
            fill: "grey"
